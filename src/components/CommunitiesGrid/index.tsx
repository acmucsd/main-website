    ...
    return (
        ...
        >
            <div className="communitiesGrid">
                <a href="#" className={`communitiesGrid__community ${hasBeenVisible ? 'ai--visible' : ' '}`}>
                    <img src={AILogo} alt="ACM AI"/>
                    <div className="communitiesGrid__community__label">
                        <h3><span>ACM</span> AI</h3>
                    </div>
                </a>
                <a href="#" className={`communitiesGrid__community ${hasBeenVisible ? 'cyber--visible' : ' '}`}>
                    <img src={CyberLogo} alt="ACM Cyber"/>
                    <div className="communitiesGrid__community__label">
                        <h3><span>ACM</span> Cyber</h3>
                    </div>
                </a>
                <a href="#" className={`communitiesGrid__community ${hasBeenVisible ? 'design--visible' : ' '}`}>
                ...
                <a href="#" className={`communitiesGrid__community ${hasBeenVisible ? 'hack--visible' : ' '}`}>
                    <img src={HackLogo} alt="ACM Hack"/>
                    <div className="communitiesGrid__community__label">
                        <h3><span>ACM</span> Hack</h3>
                    </div>
                </a>
                <a href="#" className={`communitiesGrid__community ${hasBeenVisible ? 'innovate--visible' : ' '}`}>
